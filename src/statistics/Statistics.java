...
public class Statistics {
	...
	public static double FProbability(double F, int df1, int df2) {
		...
		return incompleteBeta(df2 / 2.0, df1 / 2.0, df2
				/ (df2 + df1 * F));
	}
	...
	static double errorFunctionComplemented(double a) {
		...
		double P[] = { 2.46196981473530512524E-10,
		...
		double R[] = { 5.64189583547755073984E-1,
	...
	static double gamma(double x) {
		...
		double P[] = { 1.60119522476751861407E-4,
		...
		double Q[] = { -2.31581873324120129819E-5,
